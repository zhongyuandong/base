...
//        System.out.println(elv2);
        ...
        selectSqlB = "select ap9f(id,type) from test0513_7.source_table1_7";
          ...
          selectSqlB = "select name,type,test_functions.func20_3(name,type) from test0513_7.source_table3_7";

        // selectSqlB = "select db8_Func0525_90(num1,num2) from test0513_7.source_table3_7 where str1 <> 'gg'";

//       selectSqlB = "select name,db8_Func0525_89(distinct num1,num2) local_func1 from test0513_7.source_table3_7 group by name";

//        selectSqlB = "SELECT SUM(num1) FROM test0513_7.source_table3";
//        selectSqlB = "SELECT SUM(distinct num1) FROM test0513_7.source_table3_7";

        // selectSqlB = "select db8_Func0525_91(type) from test0513_8.source_table1_8_1";

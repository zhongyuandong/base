...
//        deleteNoteBook(list);
    ...
    public static void queryData () throws Exception {
        ...
        String text = "%spark.sql \n" +
                "select default.zj_aes_encrypt('zjkj2023aaa'),default.zj_aes_decrypt('A41CB20B45321FCAD384CC5C5C401C28'),default.split_json_array('[{\"a\":1,\"b\":1},{\"c\":1,\"d\":1}]')[0]";
        String paragraphId = zClient.addParagraph(noteId, "the first paragraph", text);
        zClient.submitParagraph(noteId, paragraphId);
    ...
    public static void testHttpUrl () throws Exception {
